...
public class TravelAgencyApplication {
    ...
    CommandLineRunner atStartup(VacationRepository repository) {
        return args -> repository.saveAll(List.of(
                ...
                new Vacation(VacationCategory.ROMANIAN, "Mera Onix", 4, "Jupiter", 8.9, 7350, 7, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque pulvinar lacinia venenatis. Vestibulum tristique congue velit, vitae tincidunt elit tempor sed. Quisque laoreet, eros sed hendrerit maximus, sapien mi consectetur sapien, ut tincidunt leo risus et erat. Fusce ornare iaculis imperdiet. Sed in accumsan quam, eu dapibus ex. In facilisis, turpis in placerat accumsan, leo mi euismod odio, non blandit elit urna nec justo.", List.of(
                ...
                new Vacation(VacationCategory.EXOTIC, "Hotel Saturn", 5, "Saturn", 7.7, 6200, 7, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque pulvinar lacinia venenatis. Vestibulum tristique congue velit, vitae tincidunt elit tempor sed. Quisque laoreet, eros sed hendrerit maximus, sapien mi consectetur sapien, ut tincidunt leo risus et erat. Fusce ornare iaculis imperdiet. Sed in accumsan quam, eu dapibus ex. In facilisis, turpis in placerat accumsan, leo mi euismod odio, non blandit elit urna nec justo.", List.of(
                ...
                new Vacation(VacationCategory.CITY, "Vega Hotel", 5, "Mamaia", 8.9, 9000, 7, "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque pulvinar lacinia venenatis. Vestibulum tristique congue velit, vitae tincidunt elit tempor sed. Quisque laoreet, eros sed hendrerit maximus, sapien mi consectetur sapien, ut tincidunt leo risus et erat. Fusce ornare iaculis imperdiet. Sed in accumsan quam, eu dapibus ex. In facilisis, turpis in placerat accumsan, leo mi euismod odio, non blandit elit urna nec justo.", List.of(
                ...
                new Vacation(VacationCategory.SEASIDE, "Hotel Inter", 5, "Venus", 8.2, 4800, 7, "", List.of(
                ...
                new Vacation(VacationCategory.MOUNTAINS, "Hotel Golden Palace", 4, "Mamaia", 9.1, 4800, 7, "", List.of(
                ...
                new Vacation(VacationCategory.SEASIDE, "Almar Luxury", 4, "Mamaia", 9.1, 5100, 7, "", List.of(
                ...
                new Vacation(VacationCategory.DESERT, "Hotel Opera Mamaia", 4, "Mamaia", 9.1, 9850, 7, "", List.of(
