    ...
    CommandLineRunner atStartup(VacationRepository repository) {
        return args -> {
            repository.saveAll(List.of(
                    new Vacation("Phoenicia Royal Hotel", 5, "Mamaia", 8.2, 12200, 7, List.of(
                    ...
                    new Vacation("Mera Onix", 4, "Jupiter", 8.9, 7350, 7, List.of(
                    ...
                    new Vacation("Hotel Saturn", 5, "Saturn", 7.7, 6200, 7, List.of(
