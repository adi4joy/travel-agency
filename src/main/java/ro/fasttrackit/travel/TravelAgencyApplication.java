...
public class TravelAgencyApplication {
    ...
    CommandLineRunner atStartup(VacationRepository repository) {
        return args -> repository.saveAll(List.of(
                new Vacation(VacationCategory.ROMANIAN, "Phoenicia Royal Hotel", 5, "Mamaia", 8.2, 12200, 7, "Phoenicia Royal Hotel is located on the beach in Mamaia and offers a private beach and a seasonal swimming pool. All rooms at this hotel are air conditioned and feature a flat-screen TV with cable channels. Some rooms enjoy sea or lake views. Phoenicia Royal Hotel offers a wide range of seasonal services, including a children’s playground, an indoor play area, a swimming pool, children's pool and water park.", List.of(
                ...
                new Vacation(VacationCategory.ROMANIAN, "Mera Onix", 4, "Jupiter", 8.9, 7350, 7, "Located in Jupiter, 50 meters from Jupiter Beach, Mera Onix features a restaurant, bar, seasonal outdoor pool and free private parking. This 4-star hotel offers a shared lounge and air-conditioned rooms with free WiFi and a private bathroom. All hotel units have a wardrobe and a flat-screen TV. Mera Onix offers a daily continental breakfast. The property has a children's playground.", List.of(
